<template>
  <Teleport to="body">
    <div class="fixed top-3 left-3 right-3 sm:top-4 sm:right-4 sm:left-auto z-[9999] space-y-3 w-auto sm:w-full sm:max-w-sm pointer-events-none">
      <TransitionGroup name="toast">
        <div
          v-for="toast in toasts"
          :key="toast.id"
          class="bg-white rounded-lg shadow-lg border border-gray-200 p-3 sm:p-4 flex items-start gap-3 pointer-events-auto"
