<template id="login-view">
  ...
  >
    ...
    <i-lucide-eye v-if="!showPassword" class="h-4 w-4 sm:h-5 sm:w-5" />
    <i-lucide-eye-off v-else class="h-4 w-4 sm:h-5 sm:w-5" />
            ...
            <button
              ...
              :disabled="isLoading"
              class="w-full py-2.5 border border-gray-300 rounded flex items-center justify-center gap-3 hover:bg-gray-50 transition font-medium text-sm text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98]"
            >
