      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
        ...
        <aside class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-sm p-4 sm:p-5 md:p-6 lg:sticky lg:top-24">
            ...
            <!-- Year Filter -->
            <h3 class="text-sm sm:text-base font-bold text-gray-900 mb-3 sm:mb-4 mt-4 sm:mt-6">Tahun</h3>
            <div class="space-y-2">
              <label class="flex items-center space-x-2 cursor-pointer">
                ...
                />
                <span class="text-xs sm:text-sm text-gray-700">Semua</span>
              </label>
              <label
                v-for="year in years"
                :key="year"
              ...
              >
                <input
                  ...
                  class="border-gray-300 text-blue-600 focus:ring-blue-500"
                />
                <span class="text-xs sm:text-sm text-gray-700">Last {{ year }} years</span>
              </label>
            </div>
          </div>
        </aside>
