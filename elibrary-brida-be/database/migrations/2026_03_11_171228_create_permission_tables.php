...
return new class extends Migration
{
    ...
    public function up(): void
    {
         ...
         * We already added guard_name column in the prepare migration.
         * Just add the unique constraint if not present.
         */
    ...
    public function down(): void
    {
        ...
        // NOTE: Do NOT drop 'roles' table - it existed before Spatie migration
    ...
    private function hasUniqueConstraint(string $table, array $columns): bool
    {
        try {
            ...
            // Cannot check, assume not present
        }
        return false;
    }
};
